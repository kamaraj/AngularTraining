...
CREATE TABLE `pim_catalog_category_product` (
  ...
  KEY `IDX_512179C15C977207` (`product_uuid`),
  ...
  CONSTRAINT `FK_512179C15C977207` FOREIGN KEY (`product_uuid`) REFERENCES `pim_catalog_product` (`uuid`) ON DELETE CASCADE
...
INSERT INTO `pim_catalog_category_product` VALUES (_binary '‚—ôhB#¦.ö¼©¬P·',8),(_binary '$ô9ó\ïNIRº?\Úl\ïú',12);
