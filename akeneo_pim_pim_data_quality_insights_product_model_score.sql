...
--
-- Table structure for table `pim_data_quality_insights_product_model_score`
--
...
--
-- Dumping data for table `pim_data_quality_insights_product_model_score`
--

LOCK TABLES `pim_data_quality_insights_product_model_score` WRITE;
/*!40000 ALTER TABLE `pim_data_quality_insights_product_model_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `pim_data_quality_insights_product_model_score` ENABLE KEYS */;
UNLOCK TABLES;
