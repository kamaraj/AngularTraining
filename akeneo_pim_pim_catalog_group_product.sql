...
CREATE TABLE `pim_catalog_group_product` (
  ...
  PRIMARY KEY (`product_uuid`,`group_id`),
  KEY `IDX_7AC0C83A5C977207` (`product_uuid`),
  KEY `IDX_7AC0C83AFE54D947` (`group_id`),
  CONSTRAINT `FK_7AC0C83A5C977207` FOREIGN KEY (`product_uuid`) REFERENCES `pim_catalog_product` (`uuid`) ON DELETE CASCADE,
